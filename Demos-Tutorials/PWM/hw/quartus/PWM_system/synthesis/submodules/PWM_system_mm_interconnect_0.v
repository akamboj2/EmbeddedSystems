...
module PWM_system_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> epcs_flash_controller_0_epcs_control_port_agent:cp_data
	...
	wire  [95:0] pio_3_s1_agent_rf_source_data;                                                      // pio_3_s1_agent:rf_source_data -> pio_3_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_3_s1_agent_rsp_fifo_out_data;                                                   // pio_3_s1_agent_rsp_fifo:out_data -> pio_3_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_3_s1_agent:cp_data
	...
	wire  [94:0] epcs_flash_controller_0_epcs_control_port_agent_rp_data;                            // epcs_flash_controller_0_epcs_control_port_agent:rp_data -> router_004:sink_data
	...
	wire  [94:0] pio_3_s1_agent_rp_data;                                                             // pio_3_s1_agent:rp_data -> router_008:sink_data
	...
	PWM_system_mm_interconnect_0_router_002 router_006 (
	...
	PWM_system_mm_interconnect_0_router_002 router_007 (
	...
	PWM_system_mm_interconnect_0_router_002 router_008 (
	...
	PWM_system_mm_interconnect_0_router_003 router_009 (
	...
	PWM_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PWM_system_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
