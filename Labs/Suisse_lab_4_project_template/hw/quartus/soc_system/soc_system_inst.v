	soc_system u0 (
		...
		.d5mcamera_0_conduit_end_cam_data    (<connected-to-d5mcamera_0_conduit_end_cam_data>),    //      d5mcamera_0_conduit_end.cam_data
		.d5mcamera_0_conduit_end_cam_fval    (<connected-to-d5mcamera_0_conduit_end_cam_fval>),    //                             .cam_fval
		.d5mcamera_0_conduit_end_cam_lval    (<connected-to-d5mcamera_0_conduit_end_cam_lval>),    //                             .cam_lval
		.d5mcamera_0_conduit_end_cam_pixclk  (<connected-to-d5mcamera_0_conduit_end_cam_pixclk>),  //                             .cam_pixclk
		.d5mcamera_0_conduit_end_cam_reset_n (<connected-to-d5mcamera_0_conduit_end_cam_reset_n>), //                             .cam_reset_n
		.d5mcamera_0_conduit_end_cam_sclk    (<connected-to-d5mcamera_0_conduit_end_cam_sclk>),    //                             .cam_sclk
		.d5mcamera_0_conduit_end_cam_sdata   (<connected-to-d5mcamera_0_conduit_end_cam_sdata>),   //                             .cam_sdata
		.d5mcamera_0_conduit_end_cam_strobe  (<connected-to-d5mcamera_0_conduit_end_cam_strobe>),  //                             .cam_strobe
		.d5mcamera_0_conduit_end_cam_trigger (<connected-to-d5mcamera_0_conduit_end_cam_trigger>), //                             .cam_trigger
		.d5mcamera_0_conduit_end_cam_xclkin  (<connected-to-d5mcamera_0_conduit_end_cam_xclkin>),  //                             .cam_xclkin
